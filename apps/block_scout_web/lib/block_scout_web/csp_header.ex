defmodule BlockScoutWeb.CSPHeader do
  ...
  def call(conn, _opts) do
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        connect-src 'self' #{websocket_endpoints(conn)} #{additional_sources()} wss://*.bridge.walletconnect.org/ https://request-global.czilladx.com/ https://raw.githubusercontent.com/trustwallet/assets/ https://registry.walletconnect.org/data/wallets.json https://*.poa.network;\
        default-src 'self';\
  ...
  defp additional_sources() do
    System.get_env("ADDITIONAL_CONNECT_SRC_CSP")
  end
end
